...
def extract_for_account(account, target_day, test_day):
    ...
    try:
        ...
        driver.get("http://server.credcommerce.com.br:8080/login")
        ...
        wait.until(EC.element_to_be_clickable((By.XPATH, "/html/body/nav[1]/div/ul/li[2]"))).click()
        wait.until(EC.element_to_be_clickable((By.XPATH, "/html/body/nav[1]/div/ul/li[2]/ul/li[2]"))).click()
        time.sleep(3)
...
def main():
    ...
    worksheet_name = os.environ.get("WORKSHEET_NAME", "extrato_raw")
